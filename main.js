...
let calculatorMode = await inquirer.prompt([
    {
        name: "Mode",
        type: "list",
        message: "Please select mode",
        choices: ["Basic", "Area of shapes", "Advance"],
        default: "Basic",
    },
]);
if (calculatorMode.Mode === "Basic") {
    ...
    if (basicMode.Mode === "Addition" || basicMode.Mode === "Subtraction" || basicMode.Mode === "Multiplication" || basicMode.Mode === "Division" || basicMode.Mode === "Exponents") {
        ...
        if (numFour.value1 % 2 === 0) {
            ...
            console.log(chalk.cyanBright(`Result: ${numFour.value1} is odd number`));
        }
    }
    else {
...
else if (calculatorMode.Mode === "Area of shapes") {
    let InterMode = await inquirer.prompt([{
            name: "Mode",
            type: "list",
            choices: [
                "Square",
